    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Form Ms Cuti</h3>
          <div class="box-tools pull-right">
            <button type="button" id="btn-add" class="btn btn-primary">
              <i class="fa fa-plus"></i> Add</button>
          </div>
        </div>
        <div class="box-body" id="form_ms_cuti" style="display: none;">
        </div>
        <div class="box-body" id="data_ms_cuti">
          <?=create_table("tb_ms_cuti","M_ms_cuti",["class"=>"table table-bordered" ,"style" => "width:100% !important;"])?>
        </div>
