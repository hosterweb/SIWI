    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Laporan Pinjaman Pegawai</h3>
        </div>
        <div class="box-body">
        <?=form_open("laporan/rekap_pinjaman/rekap_data",["target"=>"_blank","method"=>"post","id"=>"form_laporan_pegawai"])?>
            <?=create_select2([
            ...
            <?=create_inputDaterange("periode_pinjaman",["locale"=>["format"=>"YYYY-MM-DD","separator"=>"/"]])?>
        </div>
